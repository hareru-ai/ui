...
- **Accessible components** — 55 components built on [Base UI](https://base-ui.com/) primitives. WAI-ARIA compliant.
...
| [`@hareru/ui`](./packages/ui) | 55 React components with semantic CSS styling |
