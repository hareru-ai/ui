...
- **Accessible components** — 49 components built on [Base UI](https://base-ui.com/) primitives. WAI-ARIA compliant.
...
| [`@hareru/ui`](./packages/ui) | 49 React components with semantic CSS styling |
