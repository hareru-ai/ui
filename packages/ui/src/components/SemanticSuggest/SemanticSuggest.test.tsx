...
describe('SemanticSuggest', () => {
  ...
  it('calls onAccept when accept button clicked', async () => {
    ...
    render(
      <SemanticSuggest type="add_synonym" title="Test" status="pending" onAccept={handleAccept} />,
    );
  ...
  it('calls onReject when reject button clicked', async () => {
    ...
    render(
      <SemanticSuggest type="add_synonym" title="Test" status="pending" onReject={handleReject} />,
    );
  ...
  it('shows confidence percentage in header', () => {
    render(<SemanticSuggest type="add_synonym" title="Test" confidence={0.92} />);
  ...
  it('sets data-type attribute', () => {
    render(<SemanticSuggest type="add_gotcha" title="Test" />);
    expect(screen.getByRole('article')).toHaveAttribute('data-type', 'add_gotcha');
  });
  ...
  it('forwards className', () => {
    render(<SemanticSuggest type="add_synonym" title="Test" className="custom-class" />);
  ...
  it('uses article element with aria-label', () => {
    ...
    expect(article).toHaveAttribute('aria-label', 'My suggestion');
  });
});
