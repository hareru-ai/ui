...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tab value="Code">
    ...
    <BentoGrid layouts={layouts} rowHeight={80} gap={[12, 12]}>
      <BentoGridItem key="a">
        <Card><CardHeader><CardTitle>Visits</CardTitle></CardHeader><CardContent>12,340</CardContent></Card>
      </BentoGridItem>
      <BentoGridItem key="b">
        <Card><CardHeader><CardTitle>Revenue</CardTitle></CardHeader><CardContent>$4,200</CardContent></Card>
      </BentoGridItem>
    </BentoGrid>
    ```
  </Tab>
