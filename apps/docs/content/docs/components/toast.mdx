...
`Toaster` must be placed in the provider tree (typically in your root layout). See [Getting Started](/docs/getting-started) for the full provider setup.
...
<RegistryStates name="Toast" />

## Accessibility

<RegistryA11y name="Toast" />
