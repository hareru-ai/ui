...
<Tabs items={['Preview', 'Code']}>
  <Tab value="Preview">
    <ComponentPreview name="chat-message-demo" />
  </Tab>
  <Tab value="Code">
    ```tsx
    ...
    <ChatMessage variant="assistant">
      <ChatMessageContent>Here's how to get started...</ChatMessageContent>
      <ChatMessageTimestamp dateTime="2025-01-15T10:30:00Z">10:30 AM</ChatMessageTimestamp>
    </ChatMessage>
    ```
  </Tab>
</Tabs>
