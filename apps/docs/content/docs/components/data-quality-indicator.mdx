...
<Tabs items={['Preview', 'Code']}>
  <Tab value="Preview">
    <ComponentPreview name="data-quality-indicator-demo" />
  </Tab>
  <Tab value="Code">
    ```tsx
    ...
    <DataQualityIndicator
      ...
      onDetailClick={() => console.log("show details")}
    />
    ```
  </Tab>
</Tabs>
...
<RegistryStates name="DataQualityIndicator" />

## Accessibility

<RegistryA11y name="DataQualityIndicator" />
