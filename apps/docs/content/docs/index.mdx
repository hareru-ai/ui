...
Hareru UI is a semantic design system built for agents. It provides 60 accessible React components, a registry-first architecture, and first-class AI agent integration via MCP server, CLI, and machine-readable contracts.
