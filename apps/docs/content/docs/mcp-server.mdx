...
| `hareru-ui://components` | Component registry with CVA variants, props, and slot contracts |
...
| Tool | Input | Output |
|------|-------|--------|
| `get-component-usage` | `componentName: string` | Markdown: import, variants table, props, JSX example, slot tree (compound components), states, accessibility, and examples when available |
